...
class UserLoginModel(db.Model, UserMixin):
    ...
    shares = relationship("SharePictureModel",
                          backref="userlogin", lazy=True, cascade="delete")
    pictures = relationship(
        "PictureModel", backref="userlogin", lazy=True, cascade="delete")
...
class PictureModel(db.Model):
    ...
    shares = relationship("SharePictureModel",
                          backref="picture", lazy=True, cascade="delete")
